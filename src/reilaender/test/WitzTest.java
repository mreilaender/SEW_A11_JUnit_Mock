...
public class WitzTest {
	...
	public void testReadJokeNegativeParameter() {
		String expected = "Ein Ehemann tritt auf eine dieser Jahrmarktswaagen, die einem beim Wiegen das Schicksal voraus-"+
				...
				"und sagt: »Ich habe eine gute und eine schlechte Nachricht für Sie.« »Welches ist die schlechte"+  
				"Nachricht?«, will der Mann wissen. »Ich fürchte, Sie haben eine sehr seltene, unheilbare Krankheit.«"+  
				...
				"die beiden Frauen und gehen in die Küche. Die beiden älteren Herren unterhalten sich weiter."+  
				"Einer sagt: »Gestern Abend waren wir in einem neuen Restaurant, das war wirklich toll. Ich kann es"+
				"nur empfehlen.« Darauf der andere: »Wie hieß denn das Restaurant?« Der erste Mann denkt"+  
				"lange nach und sagt schließlich: »Wie heißt doch noch diese Blume, die man manchmal einer Frau"+  
				"gibt,wenn man sie liebt? Sie wissen schon … sie ist rot und hat Dornen.« »Sie meinen eine Rose?«"+  
				"»Ja, richtig«, antwortet der andere. Dann wendet er sich in Richtung der Küche und ruft: »Rose, wie"+  
				"hieß noch das Restaurant, in dem wir gestern waren?«|"+
				...
				"Zwei Jäger gehen durch den Wald, da bricht der eine plötzlich zusammen. Es sieht aus, als würde er"+  
				"nicht mehr atmen, und seine Augen sind glasig. Der andere zieht sein Handy heraus und wählt"+
				"den Notruf. »Mein Freund ist tot«, keucht er, »was soll ich tun?« »Immer mit der Ruhe«, sagt der"+  
				"Mann am anderen Ende. »Erst mal müssen wir genau wissen, ob er tot ist.« Schweigen, dann hört"+  
				...
				"was ihm an Windows 95 am besten gefallen hätte. Seine Antwort: \"Das ihr damit arbeiten müsst...\"|"+
				...
				"Der größte Vorteil des iPhones ist: Frauen können nur noch solange telefonieren, wie der Akku reicht.|"+
				"iPhone-User trifft Android-User.  iPhone-User: \"Sorry, ich bin zu spät, mein Wecker hat nicht geklingelt!\""+
				"Android-User: \"Treffen war doch sowieso verschoben. SMS nicht bekommen?|"+
				"Frage: Was bedeutet \"Booten\"? Antwort: Laß es mich so erklären:"+
				"Es gibt Programme, die ziehen dir die Schuhe aus. Danach mußt du neu booten... |"+
